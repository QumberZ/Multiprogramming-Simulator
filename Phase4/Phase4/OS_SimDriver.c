...
int main(int argc, char **argv)
{
	...
	if (programRunFlag == True && (mdDisplayFlag == True || runSimFlag == True))
	{
		...
		// otherweise, assume meta data upload file
		else
		{
			// show error message
			// function: printf
...
void showProgramFormat()
{
	// print out command line argument instruction:
	// function: printf
